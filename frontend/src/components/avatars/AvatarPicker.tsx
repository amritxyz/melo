    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2">
        <div className="flex gap-1.5">
          <button
            ...
            onClick={() => setTab('svg')}
            disabled={disabled}
            className={`flex items-center gap-1.5 px-2.5 py-1 rounded-none text-xs font-mono transition-colors cursor-pointer border ${
              tab === 'svg'
      ...
      {tab === 'svg' ? (
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 p-2.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none">
            <div className="w-12 h-12 rounded-none overflow-hidden shrink-0 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono px-1.5 py-0.5 rounded-none bg-transparent text-zinc-700 dark:text-zinc-300 border border-zinc-300 dark:border-zinc-700">
                  {activeAvatar.badge}
                </span>
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 max-h-48 overflow-y-auto p-1.5 border border-zinc-200 dark:border-zinc-800 rounded-none bg-zinc-50/50 dark:bg-zinc-950">
              {MELO_AVATARS.map((avatar) => {
                ...
                return (
                  <button
                    ...
                    disabled={disabled}
                    className={`group relative flex flex-col items-center p-1 rounded-none transition-colors cursor-pointer border ${
                      isSelected
                  ...
                  >
                    <div className="w-10 h-10 rounded-none overflow-hidden border border-zinc-200 dark:border-zinc-700">
                    ...
                    {isSelected && (
                      <span className="absolute top-1 right-1 w-3.5 h-3.5 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 rounded-none flex items-center justify-center">
        ...
        <div className="space-y-3">
          ...
          {customUrlInput && (
            <div className="flex items-center gap-3 p-2.5 rounded-none bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
              <img
                src={customUrlInput}
                alt="Preview"
                className="w-10 h-10 rounded-none object-cover border border-zinc-200 dark:border-zinc-700"
                onError={(e) => {
